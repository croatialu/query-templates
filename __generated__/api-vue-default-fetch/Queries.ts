...
import { Api, HttpResponse, RequestParams, TypeApiResponse, TypeOrder, TypePet, TypeUser } from "./api";
...
type CustomQueryOptions<T, E> = MaybeRef<
  Omit<UnwrapRef<UseQueryOptions<HttpResponse<T, E>, E>>, "queryKey" | "queryFn">
>;
// @ts-ignore
